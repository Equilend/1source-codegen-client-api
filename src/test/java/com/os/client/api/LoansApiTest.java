...
public class LoansApiTest {
    ...
    public void ledgerLoansLoanIdCancelPostTest() throws Exception {
        String loanId = null;
        LedgerResponse response = api.ledgerLoansLoanIdCancelPost(loanId);
    ...
    public void ledgerLoansLoanIdDeclinePostTest() throws Exception {
        String loanId = null;
        LedgerResponse response = api.ledgerLoansLoanIdDeclinePost(loanId);
     ...
     */
    @Test
    public void ledgerLoansLoanIdSplitLoanSplitIdApprovePostTest() throws Exception {
        List<LoanSplitLotAppoval> body = null;
        String loanId = null;
        String loanSplitId = null;
        LedgerResponse response = api.ledgerLoansLoanIdSplitLoanSplitIdApprovePost(body, loanId, loanSplitId);
