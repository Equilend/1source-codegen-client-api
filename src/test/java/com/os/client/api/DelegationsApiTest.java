...
public class DelegationsApiTest {
     ...
     */
    @Test
    public void ledgerDelegationsDelegationIdRemovePostTest() throws Exception {
        String delegationId = null;
        LedgerResponse response = api.ledgerDelegationsDelegationIdRemovePost(delegationId);
    ...
    public void ledgerDelegationsGetTest() throws Exception {
        ...
        DelegationAuthorizationType authorization = null;
        Delegations response = api.ledgerDelegationsGet(size, delegationStatus, authorization);
