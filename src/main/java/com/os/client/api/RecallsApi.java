...
public class RecallsApi {
     ...
     * @param size Number of recalls to fetch. Can be used to facilitate paging (optional)
     * @param recallStatus Recalls with status matching RECALL STATUS (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ledgerLoansLoanIdRecallsGetCall(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RecallStatus recallStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call ledgerLoansLoanIdRecallsGetValidateBeforeCall(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RecallStatus recallStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerLoansLoanIdRecallsGetCall(loanId, since, before, size, recallStatus, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Recalls ledgerLoansLoanIdRecallsGet(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RecallStatus recallStatus) throws ApiException {
        ApiResponse<Recalls> resp = ledgerLoansLoanIdRecallsGetWithHttpInfo(loanId, since, before, size, recallStatus);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Recalls> ledgerLoansLoanIdRecallsGetWithHttpInfo(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RecallStatus recallStatus) throws ApiException {
        com.squareup.okhttp.Call call = ledgerLoansLoanIdRecallsGetValidateBeforeCall(loanId, since, before, size, recallStatus, null, null);
     ...
     */
    public com.squareup.okhttp.Call ledgerLoansLoanIdRecallsGetAsync(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RecallStatus recallStatus, final ApiCallback<Recalls> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerLoansLoanIdRecallsGetValidateBeforeCall(loanId, since, before, size, recallStatus, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Recalls>(){}.getType();
