...
public class EventsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Events ledgerContractsContractIdEventsGet(String contractId, List<EventType> eventType, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Events> ledgerContractsContractIdEventsGetWithHttpInfo(String contractId, List<EventType> eventType, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ledgerContractsContractIdEventsGetAsync(String contractId, List<EventType> eventType, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size, final ApiCallback<Events> callback) throws ApiException {
