...
public class EventsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Events ledgerEventsGet(List<EventType> eventType, Integer beforeEventId, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size, SortOrder sortOrder) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Events> ledgerEventsGetWithHttpInfo(List<EventType> eventType, Integer beforeEventId, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size, SortOrder sortOrder) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ledgerEventsGetAsync(List<EventType> eventType, Integer beforeEventId, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size, SortOrder sortOrder, final ApiCallback<Events> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Events ledgerLoansLoanIdEventsGet(String loanId, List<EventType> eventType, Integer beforeEventId, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size, SortOrder sortOrder) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Events> ledgerLoansLoanIdEventsGetWithHttpInfo(String loanId, List<EventType> eventType, Integer beforeEventId, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size, SortOrder sortOrder) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ledgerLoansLoanIdEventsGetAsync(String loanId, List<EventType> eventType, Integer beforeEventId, Integer fromEventId, OffsetDateTime since, OffsetDateTime before, Integer size, SortOrder sortOrder, final ApiCallback<Events> callback) throws ApiException {
