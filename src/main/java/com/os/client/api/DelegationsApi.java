...
public class DelegationsApi {
    ...
    /**
     * Build call for ledgerDelegationsDelegationIdRemovePost
     * @param delegationId The unique identifier of a party delegation (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ledgerDelegationsDelegationIdRemovePostCall(String delegationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/ledger/delegations/{delegationId}/remove"
            .replaceAll("\\{" + "delegationId" + "\\}", apiClient.escapeString(delegationId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call ledgerDelegationsDelegationIdRemovePostValidateBeforeCall(String delegationId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'delegationId' is set
        if (delegationId == null) {
            throw new ApiException("Missing the required parameter 'delegationId' when calling ledgerDelegationsDelegationIdRemovePost(Async)");
        }
        
        com.squareup.okhttp.Call call = ledgerDelegationsDelegationIdRemovePostCall(delegationId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public LedgerResponse ledgerDelegationsDelegationIdRemovePost(String delegationId) throws ApiException {
        ApiResponse<LedgerResponse> resp = ledgerDelegationsDelegationIdRemovePostWithHttpInfo(delegationId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<LedgerResponse> ledgerDelegationsDelegationIdRemovePostWithHttpInfo(String delegationId) throws ApiException {
        com.squareup.okhttp.Call call = ledgerDelegationsDelegationIdRemovePostValidateBeforeCall(delegationId, null, null);
        Type localVarReturnType = new TypeToken<LedgerResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Propose removal of a party delegation in \&quot;approved\&quot; state (asynchronously)
     * 
     * @param delegationId The unique identifier of a party delegation (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ledgerDelegationsDelegationIdRemovePostAsync(String delegationId, final ApiCallback<LedgerResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerDelegationsDelegationIdRemovePostValidateBeforeCall(delegationId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<LedgerResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
