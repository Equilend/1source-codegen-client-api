...
public class ReratesApi {
     ...
     * @param size Number of rerates to fetch. Can be used to facilitate paging (optional)
     * @param rerateStatus Rerates with status matching RERATE STATUS (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ledgerLoansLoanIdReratesGetCall(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RerateStatus rerateStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call ledgerLoansLoanIdReratesGetValidateBeforeCall(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RerateStatus rerateStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerLoansLoanIdReratesGetCall(loanId, since, before, size, rerateStatus, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Rerates ledgerLoansLoanIdReratesGet(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RerateStatus rerateStatus) throws ApiException {
        ApiResponse<Rerates> resp = ledgerLoansLoanIdReratesGetWithHttpInfo(loanId, since, before, size, rerateStatus);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Rerates> ledgerLoansLoanIdReratesGetWithHttpInfo(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RerateStatus rerateStatus) throws ApiException {
        com.squareup.okhttp.Call call = ledgerLoansLoanIdReratesGetValidateBeforeCall(loanId, since, before, size, rerateStatus, null, null);
     ...
     */
    public com.squareup.okhttp.Call ledgerLoansLoanIdReratesGetAsync(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, RerateStatus rerateStatus, final ApiCallback<Rerates> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerLoansLoanIdReratesGetValidateBeforeCall(loanId, since, before, size, rerateStatus, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Rerates>(){}.getType();
