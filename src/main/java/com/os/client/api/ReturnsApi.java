...
public class ReturnsApi {
     ...
     * @param figi Returns with instrument matching FIGI (optional)
     * @param sedol Returns with instrument matching SEDOL (optional)
     * @param cusip Returns with instrument matching CUSIP (optional)
     * @param ticker Returns with instrument matching TICKER (optional)
     * @param isin Returns with instrument matching ISIN (optional)
     * @param partyId Returns with a transacting party mathing PARTY ID (optional)
     * @param venueRefKey Returns with venueRefKey matching VENUE REF KEY (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ledgerReturnsGetCall(OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId, String venueRefKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    private com.squareup.okhttp.Call ledgerReturnsGetValidateBeforeCall(OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId, String venueRefKey, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerReturnsGetCall(since, before, size, returnStatus, figi, sedol, cusip, ticker, isin, partyId, venueRefKey, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Returns ledgerReturnsGet(OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId, String venueRefKey) throws ApiException {
        ApiResponse<Returns> resp = ledgerReturnsGetWithHttpInfo(since, before, size, returnStatus, figi, sedol, cusip, ticker, isin, partyId, venueRefKey);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Returns> ledgerReturnsGetWithHttpInfo(OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId, String venueRefKey) throws ApiException {
        com.squareup.okhttp.Call call = ledgerReturnsGetValidateBeforeCall(since, before, size, returnStatus, figi, sedol, cusip, ticker, isin, partyId, venueRefKey, null, null);
        Type localVarReturnType = new TypeToken<Returns>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call ledgerReturnsGetAsync(OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus, String figi, String sedol, String cusip, String ticker, String isin, String partyId, String venueRefKey, final ApiCallback<Returns> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerReturnsGetValidateBeforeCall(since, before, size, returnStatus, figi, sedol, cusip, ticker, isin, partyId, venueRefKey, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Returns>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
