...
public class ReturnsApi {
     ...
     * @param size Number of returns to fetch. Can be used to facilitate paging (optional)
     * @param returnStatus Returns with status matching RETURN STATUS (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call ledgerLoansLoanIdReturnsGetCall(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call ledgerLoansLoanIdReturnsGetValidateBeforeCall(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerLoansLoanIdReturnsGetCall(loanId, since, before, size, returnStatus, progressListener, progressRequestListener);
        return call;
     ...
     */
    public Returns ledgerLoansLoanIdReturnsGet(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus) throws ApiException {
        ApiResponse<Returns> resp = ledgerLoansLoanIdReturnsGetWithHttpInfo(loanId, since, before, size, returnStatus);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Returns> ledgerLoansLoanIdReturnsGetWithHttpInfo(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus) throws ApiException {
        com.squareup.okhttp.Call call = ledgerLoansLoanIdReturnsGetValidateBeforeCall(loanId, since, before, size, returnStatus, null, null);
     ...
     */
    public com.squareup.okhttp.Call ledgerLoansLoanIdReturnsGetAsync(String loanId, OffsetDateTime since, OffsetDateTime before, Integer size, ReturnStatus returnStatus, final ApiCallback<Returns> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = ledgerLoansLoanIdReturnsGetValidateBeforeCall(loanId, since, before, size, returnStatus, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Returns>(){}.getType();
