...
/**
 * Loan Decline Error Reason Field Types and Expected Values:  * &#x60;RATE_VALUE&#x60; - [RebateRate](1.2.1#/RebateRate) or [FeeRate](1.2.1#/FeeRate) object.  * &#x60;BILLING_CURRENCY&#x60; - [CurrencyCd](1.2.1#/CurrencyCd) enum.  * &#x60;DIVIDEND_RATE&#x60; - [DoubleType](1.2.1#/DoubleType) number.  * &#x60;QUANTITY&#x60; - [Quantity](1.2.1#/Quantity) number.  * &#x60;SETTLEMENT_DATE&#x60; - [DateType](1.2.1#/DateType) string.  * &#x60;TRADE_DATE&#x60; - [DateType](1.2.1#/DateType) string.  * &#x60;TERM_DATE&#x60; - [DateType](1.2.1#/DateType) string.  * &#x60;TERM_TYPE&#x60; - [TermType](1.2.1#/TermType) enum. 
 */
@Schema(description = "Loan Decline Error Reason Field Types and Expected Values:  * `RATE_VALUE` - [RebateRate](1.2.1#/RebateRate) or [FeeRate](1.2.1#/FeeRate) object.  * `BILLING_CURRENCY` - [CurrencyCd](1.2.1#/CurrencyCd) enum.  * `DIVIDEND_RATE` - [DoubleType](1.2.1#/DoubleType) number.  * `QUANTITY` - [Quantity](1.2.1#/Quantity) number.  * `SETTLEMENT_DATE` - [DateType](1.2.1#/DateType) string.  * `TRADE_DATE` - [DateType](1.2.1#/DateType) string.  * `TERM_DATE` - [DateType](1.2.1#/DateType) string.  * `TERM_TYPE` - [TermType](1.2.1#/TermType) enum. ")
