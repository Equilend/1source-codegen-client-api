...
public class RerateDeclineErrorResponse implements Serializable, OneOfRerateRerateStatusReason {
  ...
  **/
  ...
  public RerateDeclineErrorResponse addErrorsItem(RerateDeclineErrorReasonFieldValue errorsItem) {
    if (this.errors == null) {
  ...
  **/
  @Schema(description = "")
  public List<RerateDeclineErrorReasonFieldValue> getErrors() {
    return errors;
  }

  public void setErrors(List<RerateDeclineErrorReasonFieldValue> errors) {
    this.errors = errors;
  }
